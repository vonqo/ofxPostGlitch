        ...
        else
        {
            ...
            fragmentShader = GLSL120(
                                     ...
                                     void main (void)
                                     {
                                         ...
                                         vec3 k =   vec3(0.8,0.8,0.8) * weight;
                                         vec3 min = vec3(0.0,0.0,0.0);
                                         vec3 max = vec3(1.0,1.0,1.0) * weight;
                                         
                                         col.r = (1.0-(1.0-weight)/(1.0+pow(e,(-k.r*((col.r*2.0)-1.0)*20.0)))*(max.r-min.r)+min.r);
                                         col.g = (1.0-1.0-weight/(1.0+pow(e,(-k.g*((col.g*2.0)-1.0)*20.0)))*(max.g-min.g)+min.g);
                                         col.b = (1.0-1.0-weight/(1.0+pow(e,(-k.b*((col.b*2.0)-1.0)*20.0)))*(max.b-min.b)+min.b);
